%function [combining_all,median_no_spots_in_frame,trackmate_settings,combining_all_XY,combining_all_MSD]=DoG_TM_properties_func(filename,video_id,timestep_actual,clip_factor)
use_as_function=0;
if ~use_as_function
    clc;
    clear all;
   ...
   filename= 'H:\Aamir experiment data\PA Gels\To be sorted\TiE_29Jun23\C1-TiE_29Jun23_Tcells_on_IM7_50Pa003_crop1_cell_101_Model.xml';
...
if Total_no_filt_track==-0.5 %|| median_no_spots_in_frame<40
    ...
    %hold off;
    %% track properties
    Track_properties=[video_id+0*total_no_spots_in_filt_track',median_no_spots_in_frame+0*total_no_spots_in_filt_track',total_no_spots_in_filt_track',med_spot_area',med_spot_aspectratio',track_med_speed,m_linearity_forward,alpha_quality,par];
    ...
    combining_all_XY=[just_track_ID_AFA_xy,just_x,just_y,alpha_quality(just_track_ID_AFA_xy)];
    combining_all_MSD=[alpha_quality,just_msd];
