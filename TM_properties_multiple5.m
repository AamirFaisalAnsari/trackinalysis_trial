...
%     XY=str2num(filename_call(strfind(filename_call,'XY')+2:strfind(filename_call,'XY')+3));
    ...
    video_id=000;%1000*rep+XY;
    
    [combining_all,median_no_spots_in_frame]=TM_properties_func(filename_call,video_id,interval,clip_factor);
...
writecell(mega_combine_cell_1,filename_save_full_1,'Sheet','Main');
writecell(mega_combine_cell_1,filename_save_full_2,'Sheet','Main');
...
% filename_save_mat=strcat(filename_save_full_1(1:end-5),'.mat');
% save(filename_save_mat,'median_no_spots_in_frame_saved');

filename_save_mat=strcat(filename_save_full_1,'.mat');
save(filename_save_mat,'median_no_spots_in_frame_saved');
