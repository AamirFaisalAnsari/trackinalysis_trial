...
filenames = {'20220905_Tcells_calyculin_5min_20x_2022_09_05__16_23_03__p','20220906_Tcells_calyculin_5min_20x_2022_09_06__15_28_09__p'};
folders = {'20220905','20220906'};
...
for p=startp(file):maxp(file)
    
p
%working directory
dirPath=strcat('/Volumes/SarahANew/Tcells_calyculin/', folder, '/');
...
redname=strcat(dirPath,filename,pstr,'_red.tif');
red=imread(redname);

redsaveName=strcat(dirPath,filename,pstr,'_red_reg.tif');
...
greenname=strcat(dirPath,filename,pstr,'_green.tif');
green=imread(greenname);

greensaveName=strcat(dirPath, filename,pstr,'_green_reg.tif');
